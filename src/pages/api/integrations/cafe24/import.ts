...
import { fetchProducts } from '../../../../../src/lib/adapters/cafe24'
import { upsertProductFromExternal } from '../../../../../src/lib/importers/cellmate'

export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    const shopId = (req.query.shopId as string) || (req.body && req.body.shopId) || 'onedns2'
