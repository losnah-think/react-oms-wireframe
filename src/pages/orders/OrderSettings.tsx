...
const OrderSettings: React.FC<OrderSettingsProps> = ({ onSave }) => {
  const [activeTab, setActiveTab] = useState<
    "general" | "notifications" | "shipping" | "returns"
  >("general");
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          주문 처리 규칙과 알림을 설정하여 효율적인 주문 관리를 구축합니다.
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange("orderNumberPrefix", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center space-x-3">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange("allowGuestCheckout", e.target.checked)
                  }
                  className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                />
                <span className="text-sm font-medium text-gray-900">
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
              <p className="text-sm text-yellow-800">
                <strong>주의:</strong> SMS 알림은 별도의 요금이 발생할 수
                있습니다.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange(
                      "shippingRules.standardShippingCost",
                      parseInt(e.target.value),
                    )
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange(
                      "shippingRules.expeditedShippingCost",
                      parseInt(e.target.value),
                    )
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="space-y-4">
              <label className="flex items-center space-x-3">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange(
                      "shippingRules.sameDayDeliveryEnabled",
                      e.target.checked,
                    )
                  }
                  className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
              ...
              {settings.shippingRules.sameDayDeliveryEnabled && (
                <div className="ml-7">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingChange(
                        "shippingRules.sameDayDeliveryCutoff",
                        e.target.value,
                      )
                    }
            ...
            <div className="space-y-4 mt-6">
              <label className="flex items-center space-x-3">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange(
                      "returnPolicy.requireReturnReason",
                      e.target.checked,
                    )
                  }
                  className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
              ...
              <label className="flex items-center space-x-3">
                <input
                  ...
                  onChange={(e) =>
                    handleSettingChange(
                      "returnPolicy.autoApproveReturns",
                      e.target.checked,
                    )
                  }
                  className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
