...
export default function EditProductPage() {
  ...
  const { mallId, productId } = router.query as {
    mallId?: string;
    productId?: string;
  };
    ...
    return (
      <Container maxWidth="full">
        <div className="p-6 text-center">
          잘못된 접근입니다. mallId 및 productId가 필요합니다.
        </div>
      </Container>
    );
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  value={draft.name || ""}
                  onChange={(e) =>
                    setDraft((d) => (d ? { ...d, name: e.target.value } : null))
                  }
              ...
              <div>
                ...
                <input
                  value={draft.mallProductName || ""}
                  onChange={(e) =>
                    setDraft((d) =>
                      d ? { ...d, mallProductName: e.target.value } : null,
                    )
                  }
                  className="w-full px-3 py-2 border rounded"
                />
              ...
              <div className="flex gap-2">
                <div className="flex-1">
                  ...
                  <input
                    type="number"
                    value={draft.mallPrice || 0}
                    onChange={(e) =>
                      setDraft((d) =>
                        d
                          ? { ...d, mallPrice: parseInt(e.target.value || "0") }
                          : null,
                      )
                    }
                    className="w-full px-3 py-2 border rounded"
                ...
                <div className="flex-1">
                  ...
                  <input
                    type="number"
                    value={draft.mallStock || 0}
                    onChange={(e) =>
                      setDraft((d) =>
                        d
                          ? { ...d, mallStock: parseInt(e.target.value || "0") }
                          : null,
                      )
                    }
                    className="w-full px-3 py-2 border rounded"
