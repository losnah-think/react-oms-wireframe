                        ...
                        <tr key={product.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm">
                              <div
                                className={`${product.price !== product.mallPrice ? "text-red-600" : "text-gray-900"}`}
                              >
                                기준: ₩{product.price.toLocaleString()}
                              </div>
                              <div
                                className={`${product.price !== product.mallPrice ? "text-red-600" : "text-gray-600"}`}
                              >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm">
                              <div
                                className={`${product.stock !== product.mallStock ? "text-red-600" : "text-gray-900"}`}
                              >
                                기준: {product.stock}개
                              </div>
                              <div
                                className={`${product.stock !== product.mallStock ? "text-red-600" : "text-gray-600"}`}
                              >
                              ...
                              {product.stock !== product.mallStock && (
                                <div className="text-xs text-red-500 mt-1">
                                  차이:{" "}
                                  {Math.abs(product.stock - product.mallStock)}
                                  개
                                </div>
                              )}
                            </div>
