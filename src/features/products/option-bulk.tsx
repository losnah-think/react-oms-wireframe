    ...
    <Container maxWidth="lg" padding="md">
      ...
      <Card padding="lg" className="mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="text-sm text-gray-600">
            옵션 수정용 CSV/Excel 파일 업로드. 첫 시트를 사용합니다.
          </div>
        </div>
      </Card>
      ...
      <Card padding="lg">
        ...
        <div className="text-sm text-gray-600 mt-2">
          첨부된 예시 파일 형식을 따르세요. 권장 컬럼(예):
        </div>
        <ul className="text-sm list-disc ml-6 mt-2">
          <li>
            <strong>option_id</strong> 또는 <strong>variant_id</strong>: 옵션
            식별자 (필수, 업데이트 매칭용)
          </li>
          <li>
            <strong>product_id</strong> 또는 <strong>id</strong>: 부모 상품
            식별자
          </li>
          <li>
            <strong>option_name</strong>, <strong>option_value</strong>: 옵션
            텍스트
          </li>
          <li>
            <strong>price</strong> 또는 <strong>selling_price</strong>: 옵션별
            가격
          </li>
          <li>
            <strong>stock</strong> 또는 <strong>variant_stock</strong>: 옵션별
            재고
          </li>
        </ul>

        <div className="mt-3 text-sm text-gray-700">
          주의: CSV 인코딩(UTF-8)과 쉼표 분리, 날짜 포맷 등을 확인하세요. 실제
          반영은 서버 API와 매핑 규칙 도입 후 동작합니다.
        </div>
      </Card>
    </Container>
  );
