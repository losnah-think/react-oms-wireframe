...
export default function VendorCategoryMappingPage() {
  ...
  const handleAddCategory = () => {
    if (!newCategoryName.trim() || !newCategoryPath.trim()) {
      showToast("카테고리명과 경로를 모두 입력해주세요", "error");
      return;
    }
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-all"
                    title="카테고리 추가"
                  >
      ...
      {showCategoryModal && (
        ...
        >
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4">내부 카테고리 추가</h3>
