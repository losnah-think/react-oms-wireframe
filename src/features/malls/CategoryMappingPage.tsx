...
const CategoryMappingPage: React.FC = () => {
  ...
  const filteredInternalCategories = internalCategories.filter((category) => {
    ...
    const matchesLevel =
      selectedLevel === "all" || category.level.toString() === selectedLevel;
    return matchesSearch && matchesLevel;
  });

  const currentMallCategories = selectedMall
    ? mallCategories[selectedMall] || []
    : [];
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            내부 카테고리와 각 쇼핑몰 카테고리 간의 매핑을 관리합니다.
          </p>
        </div>
          ...
          <>
                            ...
                            <td className="px-6 py-4">
                              <label className="inline-flex items-center">
                                <input
                                  ...
                                  onChange={() =>
                                    toggleMappingStatus(mapping.id)
                                  }
            ...
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="text-sm text-blue-800 space-y-1">
                <p>
                  1. 왼쪽에서 내부 카테고리를 선택하세요 (회색 표시는 이미
                  매핑된 카테고리)
                </p>
                <p>2. 오른쪽에서 대응하는 쇼핑몰 카테고리를 선택하세요</p>
                <p>
                  3. 두 카테고리를 모두 선택한 후 "매핑 생성" 버튼을 클릭하세요
                </p>
